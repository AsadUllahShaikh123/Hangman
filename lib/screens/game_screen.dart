...
class _GameScreenState extends State<GameScreen> {
  ...
  void initWords() {
    ...
    wordList = [];
    hintLetters = [];
    word = widget.hangmanObject.getWord().trim().toString();
//    print
...
//          desc: "You guessed it right!",
          buttons: [
            DialogButton(
              radius: BorderRadius.circular(10),
              child: Text('Next', style: TextStyle(fontSize: 18, color: Colors.green,
            ...
            DialogButton(
              radius: BorderRadius.circular(10),
              child: Text('Quit', style: TextStyle(fontSize: 18, color: Colors.red,
              fontWeight: FontWeight.bold, ),),
              onPressed: () {
                setState(() {
                  wordCount += 1;
                  if (wordCount > 0) {
                    Score score = Score(
                        ...
                        scoreDate: DateTime.now().toString(),
                        userScore: wordCount);
                    print(score.userScore.toString());
                    score_database.manipulateDatabase(score, database);
                  }
                  returnHomePage();
                  // initWords();
